...
import { CommandInvoicePositionCreate, CommandInvoicePositionDelete, CommandInvoicePositionUpdate } from 'contract/Command'
import { CreateInvoicePositionPayload, InvoicePosition, UpdateInvoicePositionPayload } from 'contract/InvoicePosition'
...
export class InvoicePositionListener {
  ...
  async invoicePositionCreateHandler(payload: CreateInvoicePositionPayload): Promise<Changed<InvoicePosition>> {
  ...
  async invoicePositionUpdateHandler(payload: UpdateInvoicePositionPayload): Promise<Changed<InvoicePosition>> {
